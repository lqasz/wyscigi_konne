 ...
 * @author Admin
 */
public class GrupowanieZespolow implements IPrzetworzenieDanych
{
    private final String nazwaKonia;
    private final String nazwaDzokeja;
    
    public GrupowanieZespolow(String kon, String dzokej)
    {
        this.nazwaKonia = kon;
        this.nazwaDzokeja = dzokej;
    }
